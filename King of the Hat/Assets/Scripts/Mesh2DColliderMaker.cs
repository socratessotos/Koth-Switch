/* credit for this script goes to BenZed https://forum.unity3d.com/threads/solved-draw-polygon2d-collider-paths-around-a-2d-mesh.334039/#post-2164071 */
...
public class Mesh2DColliderMaker : MonoBehaviour {
	...
	float leftSkin = -0.2f;
	float rightSkin = 0.2f;
	float topSkin = -0.2f;
	float bottomSkin = 0.2f;
	...
	public void CreatePolygon2DColliderPoints(Mesh mesh)
	{
	...
	Dictionary<Edge2D, int> BuildEdgesFromMesh(Mesh mesh) 
	{

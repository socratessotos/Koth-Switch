...
public class OrthoSmashCam : MonoBehaviour {
	...
	private void FindAveragePosition () {
		...
		m_DesiredPosition.x = averagePos.x;
		m_DesiredPosition.y = averagePos.y;
		m_DesiredPosition.z = -40f;
	}
